...
-- https://www.youtube.com/watch?v=m_oDI0bD6VQ&list=PLBTZqjSKn0IeKBQDjLmzisazhqQy4iGkb&index=50
...
-- Find the number of users that made in-app purchases due to the success of marketing campaign
...
---- The marketing campaign doesn't start until one day after the initial in-app purchase so users that only made one or multiple purchases on the first day do not count, nor do we count users that over time purchase
---- Only the products they purchased on the first day

--- so conditions are -
        ---1. first day purchases won't be counted
        ---2. purchasing the same product on the next day won't be counted


SELECT * from marketing_campaign where user_id IN (11,14,25)
--- here 25 will not qualify
